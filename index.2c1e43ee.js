...
n(e).storeState!==i&&u({});let t=i.getState();return l(t,s.current)},[n,i,l,u]),d=(0,Eo.useSyncExternalStore)(i.subscribe,c,c);return[d,a]}}function ER(e,t){for(let r=0;r<t.length;r++){let n=t[r];if(n.id==e)return r}return 9999}function EO(e,t,r,n){document.getElementById(r)&&document.getElementById(n)&&(document.getElementById(r).style.animation="slide-animation 0.3s ease",document.getElementById(n).style.animation="slide-animation 0.3s ease",document.getElementById(r).style.setProperty("--m",`${(t-e)*40}px`),document.getElementById(n).style.setProperty("--m",`${(e-t)*40}px`))}function EM(e,t){document.getElementById(e.id)&&document.getElementById(t.id)&&(document.getElementById(e.id).style.animation=null,document.getElementById(t.id).style.animation=null,e.transitioning=!1,t.transitioning=!1)}const EN=function(e){let t,{name:r="",initialState:n,actions:i,containedBy:a,handlers:o={}}=e;return{get key(){// lazy evaluate key on first access
...
`,EF=vv.div`
  ...
  overflow: hidden;
`;function E$(e,t){for(let r of t.state)if(r.id==e)return r.children}function EB(e){return document.getElementById(e)}function EV(e){let[t,r]=(0,eJ.useState)(!1),n=(0,eJ.useRef)({isMouseDown:!1,draggedItem:null}),i=Ez(),{swapCategory:a}=Ej(),o=E$(e.id,i).length*(wc.isMobile?80:40),s=e=>{e.stopPropagation(),n.current.isMouseDown=!1,n.current.draggedItem&&(EB(n.current.draggedItem.id).style.border=null),n.current.draggedItem=null},l=e=>{e.stopPropagation(),n.current.isMouseDown=!0},u=()=>e.displayChild&&!t?`${o}px`:"0px";return(0,eJ.useEffect)(()=>(document.addEventListener("mousedown",l),document.addEventListener("mouseup",s),()=>{document.removeEventListener("mousedown",l),document.removeEventListener("mouseup",s)}),[]),/*#__PURE__*/(0,g.jsxs)(g.Fragment,{children:[/*#__PURE__*/(0,g.jsxs)(EL,{id:e.id,children:[e.displayChild&&/*#__PURE__*/(0,g.jsx)(Sf,{"aria-label":"fold",icon:t?/*#__PURE__*/(0,g.jsx)(_3,{}):/*#__PURE__*/(0,g.jsx)(_9,{}),onClick:()=>{r(!t)},variant:"link",fontSize:wc.isMobile?"30px":null}),/*#__PURE__*/(0,g.jsx)(Sd,{fontSize:wc.isMobile?"30px":"20px",children:e.title}),/*#__PURE__*/(0,g.jsxs)("div",{style:{display:"flex",flexDirection:"row",marginLeft:"auto"},children:[/*#__PURE__*/(0,g.jsx)(ED,{children:/*#__PURE__*/(0,g.jsxs)("h1",{style:{fontSize:wc.isMobile?"1.75rem":null},children:["$",e.available]})}),/*#__PURE__*/(0,g.jsx)(ED,{children:/*#__PURE__*/(0,g.jsxs)("h1",{style:{fontSize:wc.isMobile?"1.75rem":null},children:["$",e.assigned]})})]})]}),e.displayChild&&/*#__PURE__*/(0,g.jsx)(EF,{style:{minHeight:u(),maxHeight:u()},onMouseMove:t=>{if(t.stopPropagation(),n.current.isMouseDown){if(!n.current.draggedItem){for(let t of E$(e.id,i))if(EB(t.id)&&EB(t.id).matches(":hover")){n.current.draggedItem=t;break}}if(n.current.draggedItem){for(let t of(EB(n.current.draggedItem.id).style.border="2px solid blue",E$(e.id,i)))EB(t.id).matches(":hover")&&t.id!=n.current.draggedItem.id&&a(e.id,t,n.current.draggedItem);for(let t of E$(e.id,i))t.id!=n.current.draggedItem.id&&(EB(t.id).style.border=null)}}},children:E$(e.id,i).map(e=>/*#__PURE__*/(0,g.jsx)(Ea,{title:e.title,id:e.id},e.id))})]})}var eJ=m("acw62");const EU=vv.div`
...
`,EW=vv.div`
  ...
  flex-direction: column;
  overflow: scroll;
  max-height: ${wc.isMobile?"calc(100vh - 560px)":"calc(100vh - 150px)"};
  padding-bottom: 30px;
...
`,Eq=vv.div`
  ...
  min-width: ${wc.isMobile?"200px":"100px"};
  height: 100%;
`;function EG(){return Math.random().toString(36).replace(/[^a-z]+/g,"").substr(2,10)}function EY(e){return document.getElementById(e)}const EK=function(){let e=(0,eJ.useRef)({isMouseDown:!1,draggedItem:null}),[t,r]=(0,eJ.useState)(!0),n=Ez(),{loadBudget:i,swapGroup:a}=Ej(),o=t=>{t.stopPropagation(),r(!0),e.current.isMouseDown=!1,e.current.draggedItem&&(EY(e.current.draggedItem.id).style.border=null),e.current.draggedItem=null},s=t=>{t.stopPropagation(),e.current.isMouseDown=!0};return(0,eJ.useEffect)(()=>(i(function(){let e=[];for(let t=0;t<3;t++){let r=[];for(let e=0;e<10;e++){let n=EG();r.push({title:(10*t+e).toString(),id:n,transitioning:!1})}let n=EG();e.push({title:t.toString(),id:n,children:r,transitioning:!1})}return e}()),document.addEventListener("mousedown",s),document.addEventListener("mouseup",o),()=>{document.removeEventListener("mousedown",s),document.removeEventListener("mouseup",o)}),[]),/*#__PURE__*/(0,g.jsxs)("div",{children:[/*#__PURE__*/(0,g.jsxs)(EU,{children:[/*#__PURE__*/(0,g.jsx)(vk,{variant:"link",fontSize:wc.isMobile?"2.5rem":null,children:"Create group"}),/*#__PURE__*/(0,g.jsx)(vk,{sx:{marginLeft:"auto"},variant:"link",fontSize:wc.isMobile?"2.5rem":null,children:"Delete group"})]}),/*#__PURE__*/(0,g.jsxs)(EH,{children:[/*#__PURE__*/(0,g.jsx)(Eq,{children:/*#__PURE__*/(0,g.jsx)("h1",{style:{fontSize:wc.isMobile?"1.75rem":null},id:"abc",children:"Available"})}),/*#__PURE__*/(0,g.jsx)(Eq,{children:/*#__PURE__*/(0,g.jsx)("h1",{style:{fontSize:wc.isMobile?"1.75rem":null},id:"def",children:"Assigned"})})]}),/*#__PURE__*/(0,g.jsx)(EW,{onMouseMove:t=>{if(t.stopPropagation(),e.current.isMouseDown){if(r(!1),!e.current.draggedItem){for(let t of n.state)if(EY(t.id)&&EY(t.id).matches(":hover")){e.current.draggedItem=t;break}}if(e.current.draggedItem){for(let t of(EY(e.current.draggedItem.id).style.border="2px solid blue",n.state))EY(t.id).matches(":hover")&&t.id!=e.current.draggedItem.id&&a(t,e.current.draggedItem);for(let t of n.state)t.id!=e.current.draggedItem.id&&(EY(t.id).style.border=null)}}},children:n.state.map(e=>/*#__PURE__*/(0,g.jsx)(EV,{title:e.title,assigned:100,available:80,id:e.id,displayChild:t},e.id))})]})},EX=vv.div`
  display: flex;
  flex-direction: column;
  align-items: stretch;
  width: 100%;
...
`,EZ=vv.div`
  display: flex;
  flex-direction: column;
`;function E0(){return/*#__PURE__*/(0,g.jsxs)(EX,{children:[/*#__PURE__*/(0,g.jsxs)(EQ,{children:[/*#__PURE__*/(0,g.jsx)(EJ,{children:/*#__PURE__*/(0,g.jsx)(_8,{})}),/*#__PURE__*/(0,g.jsx)(EJ,{children:/*#__PURE__*/(0,g.jsx)("h1",{children:"Money"})})]}),/*#__PURE__*/(0,g.jsx)(EZ,{children:/*#__PURE__*/(0,g.jsx)(EK,{})})]})}const E1=vv.div`
  display: flex;
  flex-direction: ${wc.isMobile?"column":"row"};
  height: 100vh;
  max-height: 100vh;
  overflow-y: hidden;
`,E2=document.getElementById("app"),E5=mK(E2);E5.render(/*#__PURE__*/(0,g.jsx)(function(){let e=/*@__PURE__*/f(b).result.sdkConfig,t=e$(e),r=wu(),[n,i]=(0,eJ.useState)("undefined");return(0,eJ.useEffect)(()=>{r.onAuthStateChanged(e=>{e?(new Date().getTime()-new Date(e.metadata.lastSignInTime).getTime()>864e5&&en(r).signOut().then(()=>{i("login")}).catch(e=>{alert(`${e.code}: ${e.message}. Please refresh your page.`),i("undefined")}),i("budget")):i("login")})},[]),/*#__PURE__*/(0,g.jsx)(p1,{toastOptions:{defaultOptions:{position:"top-right",containerStyle:{fontSize:wc.isMobile?"2rem":"auto"}}},children:/*#__PURE__*/(0,g.jsxs)(p2.Provider,{value:t,children:["undefined"==n&&/*#__PURE__*/(0,g.jsx)(Sc,{}),"login"==n&&/*#__PURE__*/(0,g.jsx)(Se,{}),"login"!=n&&"undefined"!=n&&/*#__PURE__*/(0,g.jsxs)(E1,{children:[!wc.isMobile&&/*#__PURE__*/(0,g.jsx)(SI,{}),"budget"==n&&/*#__PURE__*/(0,g.jsx)(E0,{}),wc.isMobile&&/*#__PURE__*/(0,g.jsx)(SA,{})]})]})})},{}));//# sourceMappingURL=index.2c1e43ee.js.map

//# sourceMappingURL=index.2c1e43ee.js.map
