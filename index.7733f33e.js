...
`,Eq=vv.div`
  ...
  min-width: ${wc.isMobile?"200px":"100px"};
  height: 100%;
`;function EG(){return Math.random().toString(36).replace(/[^a-z]+/g,"").substr(2,10)}function EY(e){return document.getElementById(e)}const EK=function(){let e=(0,eJ.useRef)({isMouseDown:!1,draggedItem:null}),t=(0,eJ.useRef)(),[r,n]=(0,eJ.useState)(!0),i=Ez(),{loadBudget:a,swapGroup:o}=Ej(),s=t=>{t.stopPropagation(),n(!0),e.current.isMouseDown=!1,e.current.draggedItem&&(EY(e.current.draggedItem.id).style.border=null),e.current.draggedItem=null},l=t=>{t.stopPropagation(),e.current.isMouseDown=!0};return(0,eJ.useEffect)(()=>(a(function(){let e=[];for(let t=0;t<3;t++){let r=[];for(let e=0;e<10;e++){let n=EG();r.push({title:(10*t+e).toString(),id:n,transitioning:!1})}let n=EG();e.push({title:t.toString(),id:n,children:r,transitioning:!1})}return e}()),document.addEventListener("mousedown",l),document.addEventListener("mouseup",s),()=>{document.removeEventListener("mousedown",l),document.removeEventListener("mouseup",s)}),[]),/*#__PURE__*/(0,g.jsxs)("div",{children:[/*#__PURE__*/(0,g.jsxs)(EU,{children:[/*#__PURE__*/(0,g.jsx)(vk,{variant:"link",fontSize:wc.isMobile?"2.5rem":null,children:"Create group"}),/*#__PURE__*/(0,g.jsx)(vk,{sx:{marginLeft:"auto"},variant:"link",fontSize:wc.isMobile?"2.5rem":null,children:"Delete group"})]}),/*#__PURE__*/(0,g.jsxs)(EH,{children:[/*#__PURE__*/(0,g.jsx)(Eq,{children:/*#__PURE__*/(0,g.jsx)("h1",{style:{fontSize:wc.isMobile?"1.75rem":null},id:"abc",children:"Available"})}),/*#__PURE__*/(0,g.jsx)(Eq,{children:/*#__PURE__*/(0,g.jsx)("h1",{style:{fontSize:wc.isMobile?"1.75rem":null},id:"def",children:"Assigned"})})]}),/*#__PURE__*/(0,g.jsx)(EW,{onMouseMove:t=>{if(t.stopPropagation(),e.current.isMouseDown){if(n(!1),!e.current.draggedItem){for(let t of i.state)if(EY(t.id)&&EY(t.id).matches(":hover")){e.current.draggedItem=t;break}}if(e.current.draggedItem){for(let t of(EY(e.current.draggedItem.id).style.border="2px solid blue",i.state))EY(t.id).matches(":hover")&&t.id!=e.current.draggedItem.id&&o(t,e.current.draggedItem);for(let t of i.state)t.id!=e.current.draggedItem.id&&(EY(t.id).style.border=null)}}},ref:t,children:i.state.map(e=>/*#__PURE__*/(0,g.jsx)(EV,{title:e.title,assigned:100,available:80,id:e.id,displayChild:r,scrollRef:t},e.id))})]})},EX=vv.div`
  display: flex;
  flex-direction: column;
  align-items: stretch;
  width: 100%;
