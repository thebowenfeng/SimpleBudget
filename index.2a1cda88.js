...
`,EL=vv.div`
  ...
  overflow: hidden;
`;function ED(e,t){for(let r of t.state)if(r.id==e)return r.children}function EF(e){return document.getElementById(e)}function E$(e){let[t,r]=(0,eJ.useState)(!1),n=(0,eJ.useRef)({isMouseDown:!1,draggedItem:null}),i=EM(),{swapCategory:a}=EN(),o=40*ED(e.id,i).length,s=e=>{e.stopPropagation(),n.current.isMouseDown=!1,n.current.draggedItem&&(EF(n.current.draggedItem.id).style.border=null),n.current.draggedItem=null},l=e=>{e.stopPropagation(),n.current.isMouseDown=!0},u=()=>e.displayChild&&!t?`${o}px`:"0px";return(0,eJ.useEffect)(()=>(document.addEventListener("mousedown",l),document.addEventListener("mouseup",s),()=>{document.removeEventListener("mousedown",l),document.removeEventListener("mouseup",s)}),[]),/*#__PURE__*/(0,g.jsxs)(g.Fragment,{children:[/*#__PURE__*/(0,g.jsxs)(Ez,{id:e.id,children:[e.displayChild&&/*#__PURE__*/(0,g.jsx)(Sf,{"aria-label":"fold",icon:t?/*#__PURE__*/(0,g.jsx)(_3,{}):/*#__PURE__*/(0,g.jsx)(_9,{}),onClick:()=>{r(!t)},variant:"link",fontSize:wc.isMobile?"30px":null,children:"Fold"}),/*#__PURE__*/(0,g.jsx)(Sd,{fontSize:wc.isMobile?"30px":"20px",children:e.title}),/*#__PURE__*/(0,g.jsxs)("div",{style:{display:"flex",flexDirection:"row",marginLeft:"auto"},children:[/*#__PURE__*/(0,g.jsx)(Ej,{children:/*#__PURE__*/(0,g.jsxs)("h1",{style:{fontSize:wc.isMobile?"1.75rem":null},children:["$",e.available]})}),/*#__PURE__*/(0,g.jsx)(Ej,{children:/*#__PURE__*/(0,g.jsxs)("h1",{style:{fontSize:wc.isMobile?"1.75rem":null},children:["$",e.assigned]})})]})]}),e.displayChild&&/*#__PURE__*/(0,g.jsx)(EL,{style:{minHeight:u(),maxHeight:u()},onMouseMove:t=>{if(t.stopPropagation(),n.current.isMouseDown){if(!n.current.draggedItem){for(let t of ED(e.id,i))if(EF(t.id)&&EF(t.id).matches(":hover")){n.current.draggedItem=t;break}}if(n.current.draggedItem){for(let t of(EF(n.current.draggedItem.id).style.border="2px solid blue",ED(e.id,i)))EF(t.id).matches(":hover")&&t.id!=n.current.draggedItem.id&&a(e.id,t,n.current.draggedItem);for(let t of ED(e.id,i))t.id!=n.current.draggedItem.id&&(EF(t.id).style.border=null)}}},children:ED(e.id,i).map(e=>/*#__PURE__*/(0,g.jsx)(Ea,{title:e.title,id:e.id},e.id))})]})}var eJ=m("acw62");const EB=vv.div`
