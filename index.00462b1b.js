...
`,_6=vm.div`
  ...
  overflow: hidden;
`,_8=/*#__PURE__*/(0,eX.forwardRef)(function(e,t){let r=(0,eX.useRef)();(0,eX.useMemo)(()=>{for(let t of(0,eX.Children).toArray(e.children));return 0},[e.children]);let[n,i]=(0,eX.useState)(!1);return(0,eX.useEffect)(()=>{e.displayChild&&(n?(r.current.style.minHeight="0px",r.current.style.maxHeight="0px"):(r.current.style.minHeight="1000px",r.current.style.maxHeight="1000px"))},[e.displayChild]),/*#__PURE__*/(0,p.jsxs)(p.Fragment,{children:[/*#__PURE__*/(0,p.jsxs)(_3,{ref:t,children:[e.displayChild&&/*#__PURE__*/(0,p.jsx)(ks,{"aria-label":"fold",icon:n?/*#__PURE__*/(0,p.jsx)(_Z,{}):/*#__PURE__*/(0,p.jsx)(_5,{}),onClick:()=>{i(t=>{if(e.displayChild)switch(t){case!0:return r.current.style.minHeight="1000px",r.current.style.maxHeight="1000px",!1;case!1:return r.current.style.minHeight="0px",r.current.style.maxHeight="0px",!0}return!t})},variant:"link",fontSize:wl.isMobile?"30px":null,children:"Fold"}),/*#__PURE__*/(0,p.jsx)(ko,{fontSize:wl.isMobile?"30px":"20px",children:e.title}),/*#__PURE__*/(0,p.jsxs)("div",{style:{display:"flex",flexDirection:"row",marginLeft:"auto"},children:[/*#__PURE__*/(0,p.jsx)(_4,{children:/*#__PURE__*/(0,p.jsxs)("h1",{style:{fontSize:wl.isMobile?"1.75rem":null},children:["$",e.available]})}),/*#__PURE__*/(0,p.jsx)(_4,{children:/*#__PURE__*/(0,p.jsxs)("h1",{style:{fontSize:wl.isMobile?"1.75rem":null},children:["$",e.assigned]})})]})]}),e.displayChild&&/*#__PURE__*/(0,p.jsx)(_6,{ref:r,style:{minHeight:"1000px",maxHeight:"1000px"},children:e.children})]})});var eX=h("acw62");const _9=vm.div`
...
`,Et=vm.div`
  ...
  min-width: ${wl.isMobile?"200px":"100px"};
  height: 100%;
`;function Er(e,t){for(let r=0;r<t.length;r++){let n=t[r];if(n.title==e)return r}return 9999}const En=function(){let e=(0,eX.useRef)({isMouseDown:!1,draggedItem:null}),t=(0,eX.useRef)(function(){let e=[];for(let t=0;t<3;t++){let r=(0,eX.useRef)();e.push({title:t.toString(),ref:r})}return e}()),[r,n]=(0,eX.useState)(!1),i=(0,eX.useRef)(),[a,o]=(0,eX.useState)(!0),s=(0,eX.useCallback)(()=>{o(!0),e.current.isMouseDown=!1,e.current.draggedItem&&(e.current.draggedItem.ref.current.style.border=null,e.current.draggedItem=null)},[]),l=(0,eX.useCallback)(()=>{e.current.isMouseDown=!0},[]),u=(0,eX.useCallback)(()=>{// document.getElementById("abcdefg").innerHTML = (event.pageY - (testRef.current.offsetTop - testRef.current.scrollTop)).toString()
if(e.current.isMouseDown){if(o(!1),!e.current.draggedItem){for(let r of t.current)if(r.ref.current.matches(":hover")){e.current.draggedItem=r;break}}if(e.current.draggedItem){for(let r of(e.current.draggedItem.ref.current.style.border="2px solid blue",t.current))if(r.ref.current.matches(":hover")&&r.title!=e.current.draggedItem.title){let i=Er(e.current.draggedItem.title,t.current),a=Er(r.title,t.current);t.current[a]=e.current.draggedItem,t.current[i]=r,n(e=>!e);break}for(let r of t.current)r.title!=e.current.draggedItem.title&&(r.ref.current.style.border=null)}}},[]);return(0,eX.useEffect)(()=>(document.addEventListener("mousedown",l),document.addEventListener("mouseup",s),()=>{document.removeEventListener("mousedown",l),document.removeEventListener("mouseup",s)}),[]),/*#__PURE__*/(0,p.jsxs)("div",{children:[/*#__PURE__*/(0,p.jsxs)(_9,{children:[/*#__PURE__*/(0,p.jsx)(vx,{variant:"link",fontSize:wl.isMobile?"2.5rem":null,children:"Create group"}),/*#__PURE__*/(0,p.jsx)(vx,{sx:{marginLeft:"auto"},variant:"link",fontSize:wl.isMobile?"2.5rem":null,children:"Delete group"})]}),/*#__PURE__*/(0,p.jsxs)(Ee,{children:[/*#__PURE__*/(0,p.jsx)(Et,{children:/*#__PURE__*/(0,p.jsx)("h1",{style:{fontSize:wl.isMobile?"1.75rem":null},id:"abcdefg",children:"Available"})}),/*#__PURE__*/(0,p.jsx)(Et,{children:/*#__PURE__*/(0,p.jsx)("h1",{style:{fontSize:wl.isMobile?"1.75rem":null},id:"hijklmn",children:"Assigned"})})]}),/*#__PURE__*/(0,p.jsx)(_7,{onMouseMove:u,ref:i,children:t.current.map(e=>/*#__PURE__*/(0,p.jsx)(_8,{title:e.title,assigned:100,available:80,ref:e.ref,displayChild:a}))})]})},Ei=vm.div`
  display: flex;
  flex-direction: column;
  align-items: stretch;
  width: 100%;
...
`,Es=vm.div`
  display: flex;
  flex-direction: column;
`;function El(){return/*#__PURE__*/(0,p.jsxs)(Ei,{children:[/*#__PURE__*/(0,p.jsxs)(Ea,{children:[/*#__PURE__*/(0,p.jsx)(Eo,{children:/*#__PURE__*/(0,p.jsx)(_2,{})}),/*#__PURE__*/(0,p.jsx)(Eo,{children:/*#__PURE__*/(0,p.jsx)("h1",{children:"Money"})})]}),/*#__PURE__*/(0,p.jsx)(Es,{children:/*#__PURE__*/(0,p.jsx)(En,{})})]})}const Eu=vm.div`
  display: flex;
  flex-direction: ${wl.isMobile?"column":"row"};
  height: 100vh;
  max-height: 100vh;
  overflow-y: hidden;
`,Ec=document.getElementById("app"),Ed=mG(Ec);Ed.render(/*#__PURE__*/(0,p.jsx)(function(){let e=/*@__PURE__*/c(g).result.sdkConfig,t=eD(e),r=ws(),[n,i]=(0,eX.useState)("undefined");return(0,eX.useEffect)(()=>{r.onAuthStateChanged(e=>{e?(new Date().getTime()-new Date(e.metadata.lastSignInTime).getTime()>864e5&&et(r).signOut().then(()=>{i("login")}).catch(e=>{alert(`${e.code}: ${e.message}. Please refresh your page.`),i("undefined")}),i("budget")):i("login")})},[]),/*#__PURE__*/(0,p.jsx)(pZ,{toastOptions:{defaultOptions:{position:"top-right",containerStyle:{fontSize:wl.isMobile?"2rem":"auto"}}},children:/*#__PURE__*/(0,p.jsxs)(p0.Provider,{value:t,children:["undefined"==n&&/*#__PURE__*/(0,p.jsx)(ka,{}),"login"==n&&/*#__PURE__*/(0,p.jsx)(x9,{}),"login"!=n&&"undefined"!=n&&/*#__PURE__*/(0,p.jsxs)(Eu,{children:[!wl.isMobile&&/*#__PURE__*/(0,p.jsx)(k_,{}),"budget"==n&&/*#__PURE__*/(0,p.jsx)(El,{}),wl.isMobile&&/*#__PURE__*/(0,p.jsx)(kE,{})]})]})})},{}));//# sourceMappingURL=index.00462b1b.js.map

//# sourceMappingURL=index.00462b1b.js.map
